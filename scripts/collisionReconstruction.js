geotab.addin.collisionReconstruction = function (api, state) {
    ...
    var vin = {},
        ...
        displayResults = function () {
			...
			"',startDate:'" + accident.speedStartTime + "'),device:!(" + currentDevice.id + "),diagnostic:!(DiagnosticEngineSpeedId),showVehicleSpeed:!f target=_blank>" + state.translate('RPM Graph') + "</a></p>" +
			"<p><b>" + state.translate('Graph Start:') + "</b> " + accidentThirtyBefore + "<br><b>" + state.translate('Time of Collision:') + "</b> " + accidentDateTime + "<br><b>" + state.translate('Graph End:') + "</b> " + accidentThirtyAfter + "</p></div>" +
			...
			"<p><b>" + state.translate('Graph Start:') + "</b> " + accidentThirtyBefore + "<br><b>" + state.translate('Time of Collision:') + "</b> " + accidentDateTime + "<br><b>" + state.translate('Graph End:') + "</b> " + accidentThirtyAfter + "</p></div>" +
			"<div id='errorMargins'><h1>" + state.translate('Margin of Error') + "</h1><p>" + state.translate('GPS coordinates are accurate to') + (isMetric ? " 2.5 " + state.translate('meters') : " 8.2 " + state.translate('feet')) + "<br>" + state.translate('Speed is accurate to') + (isMetric ? " 3.6 " + state.translate('km/h') : " 2.2 " + state.translate('mph')) + "<br>" + state.translate('The point of impact is an estimate based on the angle calculated from the accelerometer and may vary.') + "</div>" +
